...
let songs = [
  { songname: "Music", filepath: "songs/1.mp3", coverpath: "cover/1.jpg" ,timestamp:"03:26"},
  { songname: "Healer", filepath: "songs/2.mp3", coverpath: "cover/2.jpg" ,timestamp:"01:12"},
  { songname: "Revive", filepath: "songs/3.mp3", coverpath: "cover/3.jpg",timestamp:"19:27" },
  { songname: "Comeback", filepath: "songs/4.mp3", coverpath: "cover/4.jpg" ,timestamp:"02:27"},
  { songname: "Pain", filepath: "songs/5.mp3", coverpath: "cover/5.jpg" ,timestamp:"12:46"},
  { songname: "Work", filepath: "songs/6.mp3", coverpath: "cover/6.jpg" ,timestamp:"02:37"},
];

songitem.forEach((element, i) => {
  element.getElementsByTagName("img")[0].src = songs[i].coverpath;
  element.getElementsByClassName("songname")[0].innerText = songs[i].songname;
  element.getElementsByClassName("timestamp2")[0].innerText = songs[i].timestamp;
});
